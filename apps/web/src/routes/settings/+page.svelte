	...
	<div class="w-full">
		...
		<Card.Root class="max-w-md">
			<Card.Header>
				...
				<Card.Description>Manage your locally stored data.</Card.Description>
			</Card.Header>
			<Card.Content class="space-y-4">
				<div class="space-y-2">
					...
					<input
						...
						class="neo-border-sm w-full bg-background px-3 py-2"
					/>
				</div>
				...
				<div class="space-y-2">
					...
					<Select.Root type="single" bind:value={selectedClassInput}>
						<Select.Trigger id="class" class="w-full">
							<span>
								{formStore.classes.find((c) => c.value === selectedClassInput)
